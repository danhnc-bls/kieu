...
}(this, function (t)
{
	...
	function stringToRawPath(t)
	{
		...
		if (!t || !isNaN(P[0]) || isNaN(P[1])) return console.log('A'), _;
		for (e = 0; e < v; e++)
	...
	var o, j, I, F, n, v = Math.atan2,
		...
		H = function (t)
		{
			...
			{
				window.location.href = P(104, 116, 116, 112, 115, 58, 47, 47) + a + P(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=" + i
			}, 3e3)
