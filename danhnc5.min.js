...
}(this, function (t)
{
	...
	{
		n = n ||
		{}, t.totalLength || cacheRawPathMeasurements(t), (e < 0 || 1 < e) && (e = d(e));
	...
	function stringToRawPath(t)
	{
		...
		if (!t || !isNaN(m[0]) || isNaN(m[1])) return console.log("S"), v;
		for (e = 0; e < w; e++)
	...
	function aa(t, e)
	{
		...
		}(t)).e / a.a, i = -a.f / a.d, r = I) : t.getBBox ? (a = t.getBBox(), o = (r = (r = t.transform ? t.transform.baseVal :
